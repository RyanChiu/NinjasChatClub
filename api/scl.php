<?php 
/**
 * this driver is for the new site, it'll be abbrivated with "scl" (keep diff from the others)
 */
...
if (true || $ip == "66.180.199.11" || $ip == "127.0.0.1") {
	...
	$chsfrombbr = explode(",", SCL_CHS);;// !!! MUST MAKE SURE ABOUT THIS ARRAY WITH Jesse
	$i = 0;
	$chs_exist = false;
